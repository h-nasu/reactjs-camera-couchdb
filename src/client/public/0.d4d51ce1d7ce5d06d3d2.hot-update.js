...
/***/ function(module, exports, __webpack_require__) {
	...
	var CameraComponent = function (_React$Component) {
	  ...
	  function CameraComponent(props) {
	    ...
	    _this.videoElement = _react2.default.createElement("video");
	    _this.audioSelect = _react2.default.createElement("select");
	    _this.videoSelect = _react2.default.createElement("select");
	    _this.state = {
	      captures: []
	    };
	    //this.initElements();
	  ...
	  */
	  ...
	  _createClass(CameraComponent, [{
	    ...
	    value: function successCallback(stream) {
	      ...
	      this.videoElement.props.src = window.URL.createObjectURL(stream);
	      this.videoElement.props.play();
	    }
	  }, {
	    key: "errorCallback",
	    ...
	    value: function start() {
	      if (window.stream) {
	        this.videoElement.props.src = null;
	        window.stream.stop();
	      }
...
//# sourceMappingURL=0.d4d51ce1d7ce5d06d3d2.hot-update.js.map