	...
	var CameraComponent = function (_BaseComponent) {
	  ...
	  _createClass(CameraComponent, [{
	    ...
	    value: function _captureImage() {
	      ...
	      (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload/' + uuid).then(this._checkStatus).then(this._parseJSON).then(function () {
...
//# sourceMappingURL=0.a363c16fe30495faf666.hot-update.js.map