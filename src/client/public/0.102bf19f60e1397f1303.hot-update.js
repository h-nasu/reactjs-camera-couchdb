...
/***/ function(module, exports, __webpack_require__) {
	...
	var CameraComponent = function (_React$Component) {
	  ...
	  function CameraComponent(props) {
	    ...
	    _this.audioSelect = _this.audioSelect.bind(_this);
	    _this.videoSelect = _this.videoSelect.bind(_this);
	    _this.state = {
	      videoSrc: '',
	      captures: []
	    };
	  ...
	  */
	  ...
	  _createClass(CameraComponent, [{
	    ...
	    value: function successCallback(stream) {
	      ...
	      this.state.videoSrc = window.URL.createObjectURL(stream);
...
//# sourceMappingURL=0.102bf19f60e1397f1303.hot-update.js.map