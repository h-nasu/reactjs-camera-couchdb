	  ...
	  _createClass(CameraComponent, [{
	    ...
	    value: function _captureImage() {
	      ...
	      (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload/' + uuid, {
	        ...
	        console.log(resData);
	        (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload/' + resData.id + '/blob.jpg?_rev=' + resData.rev, {
	          method: 'put',
	          body: data
...
//# sourceMappingURL=0.cfb8a54444fd4a4e22a3.hot-update.js.map