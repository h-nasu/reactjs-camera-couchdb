	  ...
	  _createClass(CameraComponent, [{
	    ...
	    value: function _captureImage() {
	      ...
	      (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload/' + uuid, {
	        ...
	        console.log(resData);
	        data.append('_rev', resData.rev);
	        (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload/' + resData.id + '/?_rev=' + resData.rev, {
	          method: 'put',
	          body: data
...
//# sourceMappingURL=0.a1b4b2b71d7795a56d5d.hot-update.js.map