	  ...
	  _createClass(CameraComponent, [{
	    ...
	    value: function _captureImage() {
	      ...
	      (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload/' + uuid, {
	        ...
	        console.log(resData);
	        (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload/' + resData.id + '/attachment?rev=' + resData.rev, {
	          method: 'put',
	          headers: {
	            'Accept': 'application/json'
	          },
...
//# sourceMappingURL=0.9aeeeabbb38df21e67f0.hot-update.js.map