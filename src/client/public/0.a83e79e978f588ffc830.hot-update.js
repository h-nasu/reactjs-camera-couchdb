	...
	var CameraComponent = function (_BaseComponent) {
	  ...
	  _createClass(CameraComponent, [{
	    ...
	    value: function _captureImage() {
	      ...
	      data.append('id', new Date().toISOString());
	      (0, _isomorphicFetch2.default)('http://localhost:5984/test-upload', {
	        method: 'put',
	        body: data
...
//# sourceMappingURL=0.a83e79e978f588ffc830.hot-update.js.map